...
( function( $, Backbone ) {
	...
	wc_cp_classes.WC_CP_Models = function( composite ) {
		...
		this.Component_Selection_Model = function( component, opts ) {
			...
			var Model = Backbone.Model.extend( {
				...
				get_availability_text: function() {
					if ( this.get_type() === 'variable' ) {
						...
						if ( selected_variation ) {
							return selected_variation.availability || '';
						}
					} else {
						return this.selected_product_data.availability || '';
					}

				},

				set_availability: function( value ) {
					this.selected_product_data.availability = value;
				},
		...
		this.Composite_Summary_View = function( opts ) {
			...
			var View = Backbone.View.extend( {
				...
				render_element_content_task: function( step ) {
					...
					content_data.element_availability_text = component.get_availability_text();
	...
	wc_cp_classes.WC_CP_Step_Factory = function() {
		...
		WC_CP_Component.prototype.get_availability_text = function() {
			return this.component_selection_model.get_availability_text();
		};
