...
function wc_cp_summary_widget_content( $components, $composite, $widget_options ) {
	...
	?>
	<div class="widget_composite_summary_elements composite_summary" data-summary_columns="<?php echo esc_attr( $widget_options['columns'] ); ?>">
	<?php
		wc_get_template(
...
if ( ! function_exists( 'wc_cp_wp_theme_get_element_class_name' ) ) {
	 ...
	 * @return string
	 */
	function wc_cp_wp_theme_get_element_class_name( $element ) {
		return WC_CP_Core_Compatibility::wc_current_theme_is_fse_theme() && function_exists( 'wc_wp_theme_get_element_class_name' ) ? wc_wp_theme_get_element_class_name( $element ) : '';
	}
}
