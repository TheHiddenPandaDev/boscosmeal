...
class WC_CP_Scenario {
	...
	public function contains_component_option( $component_id, $product_id, $variation_id = 0 ) {
		...
		if ( $variation_id > 0 && $product_id > 0 ) {
			...
			} elseif ( ! $this->contains_id( $component_id, $variation_id ) && ! $this->contains_id( $component_id, $product_id ) ) {
					$contains = true;
			}
		} elseif ( $product_id > 0 ) {
			if ( false === $exclude ) {
			...
			} elseif ( ! $this->contains_id( $component_id, $product_id ) ) {
					$contains = true;
			}
		} elseif ( $product_id === -1 ) {
			if ( false === $exclude ) {
	...
	public function hides_component_option( $component_id, $product_id, $variation_id = 0 ) {
		...
		if ( $variation_id > 0 && $product_id > 0 ) {
			...
			} elseif ( ! $this->contains_id( $component_id, $variation_id, $configuration ) && ! $this->contains_id( $component_id, $product_id, $configuration ) ) {
					$contains = true;
			}
		} elseif ( $product_id > 0 ) {
			if ( false === $exclude ) {
			...
			} elseif ( ! $this->contains_id( $component_id, $product_id, $configuration ) ) {
					$contains = true;
			}
		} elseif ( $product_id === -1 ) {
			if ( false === $exclude ) {
