...
<div class="options_group">
	<input type="hidden" name="bto_state_data[<?php echo esc_attr( $id ); ?>][dirty]" value="1"/>
														<?php
														...
														?>
	<div class="hr-section"><?php esc_html_e( 'State Configuration', 'woocommerce-composite-products' ); ?></div>
	<?php
