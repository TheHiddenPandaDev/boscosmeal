...
<div class="options_group">
	<input type="hidden" name="bto_scenario_data[<?php echo esc_attr( $id ); ?>][dirty]" value="1"/>
															<?php
															...
															?>
	<div class="hr-section"><?php esc_html_e( 'Conditions', 'woocommerce-composite-products' ); ?></div>
	<?php
	...
	?>
	<div class="hr-section"><?php esc_html_e( 'Actions', 'woocommerce-composite-products' ); ?></div>
	<?php
