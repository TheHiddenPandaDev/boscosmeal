			...
			function () {
				...
				foreach ( WC()->cart->get_cart() as $cart_item ) {
					if ( $container_item = wc_cp_get_composited_cart_item_container( $cart_item ) ) {
						...
						$sanitized_component_title = sanitize_title( $component_title );

						$inline_css[] = 'table.wc-block-cart-items .is-composited__ctitle_' . $sanitized_component_title . ' .wc-block-cart-item__wrap:before { display: block; content:"' . $component_title . ':" }';
						$inline_css[] = 'table.wc-block-cart-items .wc-block-cart-items__row.is-composite__meta_hidden .wc-block-components-product-details .wc-block-components-product-details__' . $sanitized_component_title . ' { display: none; }';
