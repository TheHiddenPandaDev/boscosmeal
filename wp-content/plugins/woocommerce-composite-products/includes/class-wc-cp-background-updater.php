...
if ( ! class_exists( 'WC_CP_Background_Process', false ) ) {
	include_once WC_CP_ABSPATH . 'includes/class-wc-cp-background-process.php';
}
 ...
 * @version  10.0.0
 */
class WC_CP_Background_Updater extends WC_CP_Background_Process {
